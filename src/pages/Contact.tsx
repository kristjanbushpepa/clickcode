        ...
        <Card className="max-w-4xl mx-auto bg-card/80 backdrop-blur-md border border-border shadow-2xl">
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <Button type="submit" size="lg" className="w-full bg-primary hover:bg-primary/90 text-primary-foreground shadow-lg hover:shadow-xl transition-all duration-300" style={{
